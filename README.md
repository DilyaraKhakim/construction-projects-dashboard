...
Онлайн, без установки: [открыть демо дашборда](https://dilyarakhakim.github.io/construction-projects-dashboard/) — тот же дашборд с данными трёх ЖК, работает в браузере. Изменения в демо живут только в текущей сессии браузера и не сохраняются. Файл `demo/dashboard_offline.html` также можно скачать из репозитория и открыть локально.
